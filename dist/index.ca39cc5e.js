...
var _movieApp = require("./movieApp");
(0, _movieApp.init)();

},{"./movieApp":"lyZz1"}],"lyZz1":[function(require,module,exports) {
...
parcelHelpers.export(exports, "displayNoResult", ()=>displayNoResult);
var _movieservice = require("./services/movieservice");
let movies = [];
const init = ()=>{
...
async function handleSubmit() {
    ...
    container.innerHTML = "";
    try {
        movies = await (0, _movieservice.getData)(searchText);
        if (movies.length > 0) createHtml(movies, container);
        else displayNoResult(container);
    } catch  {
        displayNoResult(container);
    }
}
const createHtml = (movies, container)=>{
...
const displayNoResult = (container)=>{
    ...
    noMessage.innerHTML = "Inga s\xf6kresultat att visa";
    container.appendChild(noMessage);
};

},{"./services/movieservice":"6LlLZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6LlLZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"form-data":"bO1KB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bO1KB":[function(require,module,exports) {
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["goQ56","4j3ZX"], "4j3ZX", "parcelRequire94c2")
